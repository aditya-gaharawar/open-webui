...
If you want to report a vulnerability and can meet the outlined requirements, [open a vulnerability report here](https://answerai.in/security/advisories/new).
...
- **Feature requests:** Create a discussion in [GitHub Discussions - Ideas](https://answerai.in/discussions/) to discuss with the community if this feature request is wanted by multiple people
...
- **General issues:** Use our [Issue Tracker](https://answerai.in/issues)
...
For any other immediate concerns, please create an issue in our [issue tracker](https://answerai.in/issues) or contact our team on [Discord](https://discord.gg/5rJgQTnV4s).
