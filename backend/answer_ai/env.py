...
ANSWERAI_AUTH_TRUSTED_NAME_HEADER = os.environ.get(
    "ANSWERAI_AUTH_TRUSTED_NAME_HEADER", None
)
...
ANSWERAI_SESSION_COOKIE_SAME_SITE = os.environ.get(
    "ANSWERAI_SESSION_COOKIE_SAME_SITE", "lax"
)
