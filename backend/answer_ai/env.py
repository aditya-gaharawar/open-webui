...
# ANSWERAI_DIR should be the directory where env.py resides (answer_ai/)
...
ANSWERAI_NAME = os.environ.get("ANSWERAI_NAME", "ANSWERAI")
...
ANSWERAI_BUILD_HASH = os.environ.get("ANSWERAI_BUILD_HASH", "dev-build")
...
ANSWERAI_AUTH = os.environ.get("ANSWERAI_AUTH", "True").lower() == "true"
...
ANSWERAI_AUTH_TRUSTED_EMAIL_HEADER = os.environ.get(
    "ANSWERAI_AUTH_TRUSTED_EMAIL_HEADER", None
)
ANSWERAI_AUTH_TRUSTED_NAME_HEADER = os.environ.get("ANSWERAI_AUTH_TRUSTED_NAME_HEADER", None)
ANSWERAI_AUTH_TRUSTED_GROUPS_HEADER = os.environ.get(
    "ANSWERAI_AUTH_TRUSTED_GROUPS_HEADER", None
)
...
ANSWERAI_AUTH_SIGNOUT_REDIRECT_URL = os.environ.get(
    "ANSWERAI_AUTH_SIGNOUT_REDIRECT_URL", None
)
...
ANSWERAI_SECRET_KEY = os.environ.get(
    "ANSWERAI_SECRET_KEY",
    os.environ.get(
        "ANSWERAI_JWT_SECRET_KEY", "t0p-s3cr3t"
    ),  # DEPRECATED: remove at next major version
)

ANSWERAI_SESSION_COOKIE_SAME_SITE = os.environ.get("ANSWERAI_SESSION_COOKIE_SAME_SITE", "lax")

ANSWERAI_SESSION_COOKIE_SECURE = (
    os.environ.get("ANSWERAI_SESSION_COOKIE_SECURE", "false").lower() == "true"
)

ANSWERAI_AUTH_COOKIE_SAME_SITE = os.environ.get(
    "ANSWERAI_AUTH_COOKIE_SAME_SITE", ANSWERAI_SESSION_COOKIE_SAME_SITE
)

ANSWERAI_AUTH_COOKIE_SECURE = (
    os.environ.get(
        "ANSWERAI_AUTH_COOKIE_SECURE",
        os.environ.get("ANSWERAI_SESSION_COOKIE_SECURE", "false"),
    ).lower()
    == "true"
)
