...
from answer_ai.retrieval.loaders.external_document import ExternalDocumentLoader

from answer_ai.retrieval.loaders.mistral import MistralLoader
from answer_ai.retrieval.loaders.datalab_marker import DatalabMarkerLoader
from answer_ai.retrieval.loaders.mineru import MinerULoader


from answer_ai.env import GLOBAL_LOG_LEVEL
    ...
    def _get_loader(self, filename: str, file_content_type: str, file_path: str):
        ...
        if (
            ...
            if not api_base_url or api_base_url.strip() == "":
                api_base_url = "https://www.datalab.to/api/v1/marker"  # https://answerai.in/pull/16867#issuecomment-3218424349
