from answer_ai.retrieval.vector.main import VectorDBBase
from answer_ai.retrieval.vector.type import VectorType
        ...
        match vector_type:
            case VectorType.MILVUS:
                if ENABLE_MILVUS_MULTITENANCY_MODE:
                    from answer_ai.retrieval.vector.dbs.milvus_multitenancy import (
                        MilvusClient,
                    )
            ...
            case VectorType.QDRANT:
                if ENABLE_QDRANT_MULTITENANCY_MODE:
                    from answer_ai.retrieval.vector.dbs.qdrant_multitenancy import (
                        QdrantClient,
                    )
            ...
            case VectorType.S3VECTOR:
                from answer_ai.retrieval.vector.dbs.s3vector import S3VectorClient
            ...
            case VectorType.ELASTICSEARCH:
                from answer_ai.retrieval.vector.dbs.elasticsearch import (
                    ElasticsearchClient,
                )
            ...
            case VectorType.ORACLE23AI:
                from answer_ai.retrieval.vector.dbs.oracle23ai import Oracle23aiClient

                return Oracle23aiClient()
            case VectorType.WEAVIATE:
                from answer_ai.retrieval.vector.dbs.weaviate import WeaviateClient
