...
app.state.config.SMTP_STARTTLS = SMTP_STARTTLS
app.state.config.EMAIL_FROM_ADDRESS = EMAIL_FROM_ADDRESS
app.state.config.EMAIL_FROM_NAME = EMAIL_FROM_NAME
app.state.config.EMAIL_VERIFICATION_ENABLED = EMAIL_VERIFICATION_ENABLED
app.state.config.EMAIL_VERIFICATION_EXPIRES_IN_SECONDS = (
    EMAIL_VERIFICATION_EXPIRES_IN_SECONDS
)
app.state.config.EMAIL_VERIFICATION_PROMOTE_ROLE = EMAIL_VERIFICATION_PROMOTE_ROLE
