...
from open_webui.config import (
    ...
    ENABLE_CODE_INTERPRETER_HISTORY,
    ENABLE_CALL_FEATURE,
    ENABLE_IMAGE_GENERATION_TOOL,
    ENABLE_IMAGE_SIGNATURE,
)
...
app.state.config.ENABLE_CODE_INTERPRETER_HISTORY = ENABLE_CODE_INTERPRETER_HISTORY
app.state.config.ENABLE_CALL_FEATURE = ENABLE_CALL_FEATURE
app.state.config.ENABLE_IMAGE_GENERATION_TOOL = ENABLE_IMAGE_GENERATION_TOOL
app.state.config.ENABLE_IMAGE_SIGNATURE = ENABLE_IMAGE_SIGNATURE
